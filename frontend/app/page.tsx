...
export default function LandingPage() {
  return (
    <main className="flex flex-col min-h-screen bg-background">
      ...
      <section className="relative flex flex-col items-center text-center px-6 pt-15 pb-16 sm:pt-32 sm:pb-24 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/auth/register" className="w-full sm:w-auto">
              <Button size="lg" className="w-full sm:w-auto h-12 px-8 text-md gap-2 shadow-lg shadow-primary/20 cursor-pointer">
                Start for free <ArrowRight className="w-4 h-4" />
              </Button>
            </Link>
            <Link href="#features" className="w-full sm:w-auto">
              <Button variant="outline" size="lg" className="w-full sm:w-auto h-12 px-8 text-md border-border bg-white/50 backdrop-blur-sm cursor-pointer">
                View features
              </Button>
            </Link>
          </div>
      ...
      <section id="features" className="px-6 py-20 sm:py-32 bg-secondary/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">Built for modern collaboration</h2>
            <p className="text-muted-foreground">Everything you need to ship projects faster.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">

            <div className="group p-8 bg-card rounded-2xl border border-border shadow-sm hover:shadow-md transition-all duration-300">
      ...
      <footer className="py-6 px-6 text-center border-t border-border bg-background">
